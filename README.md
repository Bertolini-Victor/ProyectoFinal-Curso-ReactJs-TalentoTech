...
![Firebase](https://img.shields.io/badge/Firebase-Auth%20y%20DB-039BE5?style=flat-square&logo=firebase&logoColor=white)
![React Router](https://img.shields.io/badge/React%20Router-SPA-CA4245?style=flat-square&logo=reactrouter&logoColor=white)
![Styled Components](https://img.shields.io/badge/Styled--Components-CSS--in--JS-DB7093?style=flat-square&logo=styledcomponents&logoColor=white)
![Estado](https://img.shields.io/badge/Estado-Proyecto%20Final-1E90FF?style=flat-square)
...
### 2. Base de Datos en la Nube y CRUD (Firebase Firestore)
...
### 4. UX Avanzada: Búsqueda, Paginación y Descuentos
...
2. **Ingresar a la carpeta del proyecto:**
   ...
   ```bash
   cd ProyectoFinalCurso-ReactJs-TalentoTech
   ```
...
4. **Variables de entorno (opcional):** asegurate de configurar tu propio archivo `firebase.js` en `src/config` con las credenciales de tu consola de Google Firebase si deseás usar tu propia base de datos.
...
6. **Abrir el navegador:** ingresá a la URL local provista por Vite (habitualmente `http://localhost:5173`).
